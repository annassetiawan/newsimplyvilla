  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-border bg-background p-5 space-y-4 lg:col-span-2">
          <div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border text-left">
              ...
              <th className="hidden px-5 py-2.5 text-xs font-semibold text-muted-foreground lg:table-cell">Type</th>
              <th className="px-5 py-2.5 text-xs font-semibold text-muted-foreground">Amount</th>
              <th className="hidden px-5 py-2.5 text-xs font-semibold text-muted-foreground lg:table-cell">Status</th>
            </tr>
          </thead>
          <tbody>
            {recent.length === 0 && (
